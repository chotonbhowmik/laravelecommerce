        ...
        <div id="product-tabs-slider" class="scroll-tabs outer-top-vs wow fadeInUp">
          <div class="more-info-tab clearfix ">
            ...
            <ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
              ...
              <li><a data-transition-type="backSlide" href="#{{$featured->slug}}" data-toggle="tab">{{$featured->name}}</a>
              </li>
                  ...
                  <div class="product-image">
                    ...
                    <div class="image">
                     <a href="{{ route('product.show', $value->slug)}}">
                      ...
                      <img  src="{{ asset('Backend/img/product/'. $value->image) }}" alt=""></a> 
                    </div>
                    <!-- /.image -->
                    @endif
                ...
                <div class="product">
                  <div class="product-image">
                    ...
                    <div class="image">
                     <a href="{{ route('product.show', $value->slug)}}">
                       @if(!is_null( $value->image))
                      <img  src="{{ asset('Backend/img/product/'. $value->image) }}" alt=""></a> </div>
                    <!-- /.image -->
                    @endif
